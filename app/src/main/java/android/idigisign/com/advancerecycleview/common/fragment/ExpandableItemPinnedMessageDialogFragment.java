...
package android.idigisign.com.advancerecycleview.common.fragment;

import android.app.AlertDialog;
import android.app.Dialog;
import android.content.DialogInterface;
import android.idigisign.com.advancerecycleview.R;
...
/**
 * Define a costumed Dialog Fragment for when you pin a item and show the dialog
 *
 */
...
//        ((EventListener) getActivity()
//                .getFragmentManager()
//                .findFragmentById(R.id.container))
//                .onNotifyExpandableItemPinnedDialogDismissed(groupPosition, childPosition, ok);
        ((EventListener) getTargetFragment()).onNotifyExpandableItemPinnedDialogDismissed(groupPosition, childPosition, ok);
